 ...
 * Gere une fenetre de dialogue renseignant sur les informations clientes (+sauvegarde)
 */
	...
	public void onClick(View v) {
		...
		case R.id.dialogInfoBtnValider: 
            ...
            if(m.matches()&& m1.matches() && m2.matches())
            {
            	...
            	Toast.makeText(getContext(), "Erreur dans les champs de saisie, veuillez vérifier le contenu.",Toast.LENGTH_SHORT  ).show();
            }
