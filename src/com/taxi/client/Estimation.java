  ...
  */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
			...
			map.put("description", GmapsDirection.getTrajetInfo(posTaxi, data.position).temps);
	        ...
	        TrajetInfo infos;
        	infos = GmapsDirection.getTrajetInfo(data.usrdestination, data.position);
	        ...
	        map.put("description", EstimationPrix.EstimPrix(infos.distanceValue));
